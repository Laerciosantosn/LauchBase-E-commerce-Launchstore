-- Caso ao recriar a base de dados ela venha preenchido com algumas tabela padrão
...
-- Refaz a constraint colocando a ideia de remoção em cascata
...
--Reset sequence auto increment from tables ids
...
-- 2. Criar uma regra qe vai rodar todas as vezes que solicitamos o DELETE
...
--4. Renomera a nossa VIEW e nossa TABLE
